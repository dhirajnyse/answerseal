...
const PUBLIC_BUILD_VERSION = "v3.01 Alpha";
const PUBLIC_REPORT_STORAGE_KEY = "answerseal.public.reports.v3010";
const PUBLIC_LEGACY_REPORT_STORAGE_KEYS = [
  "answerseal.public.reports.v3000",
  "answerseal.public.reports.v2990",
  "answerseal.public.reports.v2980",
  "answerseal.public.reports.v2970",
  "answerseal.public.reports.v2960",
  "answerseal.public.reports.v2950",
  "answerseal.public.reports.v2940",
  "answerseal.public.reports.v2930",
  "answerseal.public.reports.v2920",
  "answerseal.public.reports.v2910",
...
function buildProductionWorkspaceItems() {
  ...
  const seededEntries = [
    ...
    },
    {
      ...
      audit: "Review Pack v207 records Category Leadership Command, market leadership, competitive proof, ROI, executive narrative, marketplace, community signals, enterprise readiness, global expansion, board launch, category command, buyer proof, source status, and export decision",
  ...
  const seededEntries = [
    {
      ...
      migration: "answerseal.public.reports.v2460 and earlier report memory can migrate into sealed_reports without changing the first-screen verifier.",
    ...
    },
    {
      ...
      migration: "answerseal.public.reports.v2460 and answerseal.workspace.v85 become source keys for future import jobs.",
...
function buildWorkspaceDataLayerItems() {
  ...
  const seededEntries = [
    ...
    },
    {
      ...
      migration: "answerseal.public.reports.v2460 becomes an import source, not the production authority.",
      href: "records.html",
      action: "Open records",
    },
    {
...
function buildD1PersistenceBlueprintItems() {
  ...
  const reportFixtures = reports.slice(0, 2).map((report, index) => ({
    ...
    seed: `score=${Number(report.score || 0)}; status=${report.status || "sealed"}; source=answerseal.public.reports.v2460`,
  ...
  const seededEntries = [
    ...
    },
    {
      ...
      seed: "answerseal.public.reports.v2460 and answerseal.workspace.v86 dry-run import job.",
...
function buildPrivateBetaOnboardingItems() {
  ...
  const seededEntries = [
    ...
    },
    {
      ...
      actionPath: "Use this page as the customer onboarding runbook until v2.14 turns launch confidence into a buyer-ready evidence binder.",
...
if (pilotForm) {
  pilotForm.addEventListener("submit", (event) => {
    ...
    const body = [
      ...
      "",
      "Pilot phase: AnswerSeal v3.01 Alpha - Multi-Environment Control Plane",
    ].join("\n");
