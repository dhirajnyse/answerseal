...
const PUBLIC_BUILD_VERSION = "v2.4 Alpha";
const PUBLIC_REPORT_STORAGE_KEY = "answerseal.public.reports.v240";
...
function buildProductionWorkspaceItems() {
  ...
  const seededEntries = [
    ...
    },
    {
      ...
      audit: "Review Pack v110 records beta invite control room, expansion readiness board, beta friction queue, cohort signal ledger, private beta cohort room, private beta launch decision, pilot acceptance threshold, security and compliance pack, account and billing gate, live backend wiring, private beta launch gate, pilot outcome ledger, launch readiness meter, pilot feedback learning, pilot customer command, launch room, renewal memory, workspace state, source status, and export decision.",
...
if (pilotForm) {
  pilotForm.addEventListener("submit", (event) => {
    ...
    const body = [
      ...
      "",
      "Pilot phase: AnswerSeal v2.4 Alpha - Beta Invite Control Room",
    ].join("\n");
