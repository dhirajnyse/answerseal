...
const PUBLIC_BUILD_VERSION = "v2.66 Alpha";
const PUBLIC_REPORT_STORAGE_KEY = "answerseal.public.reports.v2660";
...
function buildProductionWorkspaceItems() {
  ...
  const seededEntries = [
    ...
    },
    {
      ...
      audit: "Review Pack v172 records Webhook Integration Console, renewal distribution room, renewal packet studio, shared brief follow-up console, buyer proof, launch readiness, tenant control, team operation, connector handoff, analytics, audit export, buyer portal, source status, and export decision.",
...
if (pilotForm) {
  pilotForm.addEventListener("submit", (event) => {
    ...
    const body = [
      ...
      "",
      "Pilot phase: AnswerSeal v2.66 Alpha - Webhook Integration Console",
    ].join("\n");
