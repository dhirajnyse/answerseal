...
const PUBLIC_BUILD_VERSION = "v2.16 Alpha";
const PUBLIC_REPORT_STORAGE_KEY = "answerseal.public.reports.v2160";
...
if (pilotForm) {
  pilotForm.addEventListener("submit", (event) => {
    ...
    const body = [
      ...
      "",
      "Pilot phase: AnswerSeal v2.16 Alpha - Buyer Follow-Up Console",
    ].join("\n");
