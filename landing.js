...
const PUBLIC_BUILD_VERSION = "v2.10 Alpha";
const PUBLIC_REPORT_STORAGE_KEY = "answerseal.public.reports.v2100";
...
function buildPrivateBetaOnboardingItems() {
  ...
  const seededEntries = [
    ...
    },
    {
      ...
      actionPath: "Use this page as the customer onboarding runbook until v2.10 turns support capacity into a small beta invite batch.",
...
if (pilotForm) {
  pilotForm.addEventListener("submit", (event) => {
    ...
    const body = [
      ...
      "",
      "Pilot phase: AnswerSeal v2.10 Alpha - Expansion Batch Planner",
    ].join("\n");
