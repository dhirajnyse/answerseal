...
const PUBLIC_BUILD_VERSION = "v2.23 Alpha";
const PUBLIC_REPORT_STORAGE_KEY = "answerseal.public.reports.v2230";
...
if (pilotForm) {
  pilotForm.addEventListener("submit", (event) => {
    ...
    const body = [
      ...
      "",
      "Pilot phase: AnswerSeal v2.23 Alpha - Renewal Packet Studio",
    ].join("\n");
