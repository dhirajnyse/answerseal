...
const PUBLIC_BUILD_VERSION = "v2.20 Alpha";
const PUBLIC_REPORT_STORAGE_KEY = "answerseal.public.reports.v2200";
...
if (pilotForm) {
  pilotForm.addEventListener("submit", (event) => {
    ...
    const body = [
      ...
      "",
      "Pilot phase: AnswerSeal v2.20 Alpha - Leadership Share Control Room",
    ].join("\n");
