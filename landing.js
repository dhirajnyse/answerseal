...
const PUBLIC_BUILD_VERSION = "v2.15 Alpha";
const PUBLIC_REPORT_STORAGE_KEY = "answerseal.public.reports.v2150";
...
if (pilotForm) {
  pilotForm.addEventListener("submit", (event) => {
    ...
    const body = [
      ...
      "",
      "Pilot phase: AnswerSeal v2.15 Alpha - Buyer Launch Room",
    ].join("\n");
