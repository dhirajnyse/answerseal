...
const PUBLIC_BUILD_VERSION = "v2.17 Alpha";
const PUBLIC_REPORT_STORAGE_KEY = "answerseal.public.reports.v2170";
...
if (pilotForm) {
  pilotForm.addEventListener("submit", (event) => {
    ...
    const body = [
      ...
      "",
      "Pilot phase: AnswerSeal v2.17 Alpha - Buyer Outcome Ledger",
    ].join("\n");
