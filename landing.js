...
const PUBLIC_BUILD_VERSION = "v2.18 Alpha";
const PUBLIC_REPORT_STORAGE_KEY = "answerseal.public.reports.v2180";
...
if (pilotForm) {
  pilotForm.addEventListener("submit", (event) => {
    ...
    const body = [
      ...
      "",
      "Pilot phase: AnswerSeal v2.18 Alpha - Revenue Confidence Room",
    ].join("\n");
