...
const PUBLIC_BUILD_VERSION = "v2.94 Alpha";
const PUBLIC_REPORT_STORAGE_KEY = "answerseal.public.reports.v2940";
...
function buildProductionWorkspaceItems() {
  ...
  const seededEntries = [
    ...
    },
    {
      ...
      audit: "Review Pack v200 records Category Leadership Command, market leadership, competitive proof, ROI, executive narrative, marketplace, community signals, enterprise readiness, global expansion, board launch, category command, buyer proof, source status, and export decision",
...
if (pilotForm) {
  pilotForm.addEventListener("submit", (event) => {
    ...
    const body = [
      ...
      "",
      "Pilot phase: AnswerSeal v2.94 Alpha - Category Leadership Command",
    ].join("\n");
