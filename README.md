...
**Current phase:** Account And Billing Gate

**Current release:** v1.6 Alpha - Account And Billing Gate
...
- Launch Readiness Meter on the Build page with 93% overall progress, 27/30 done, 1 active account gate, 2 pending launch gates, and 7% remaining to private beta launch
...
## Next Phase: v1.7 Alpha - Security And Compliance Pack

- Prepare privacy notes for buyer-safe trust packets
- Define evidence handling rules for metadata, excerpts, raw files, retention, export, and deletion
- Write audit log language buyers can understand quickly
- Summarize access controls, role boundaries, recovery paths, and support authority
- Package security and compliance proof for private beta buying rooms
