...
**Current version:** v2.14 Alpha

**Current phase:** Launch Evidence Binder

**Current release:** v2.14 Alpha - Launch Evidence Binder
...
- Launch Readiness and Beta Operations Meter on the Build page with 100% private-beta launch readiness, 30/30 launch phases done, 0 hidden launch gates, and beta operations at 100% with launch-binder gating
...
## Next Phase: v2.15 Alpha - Buyer Launch Room

The next release should turn the launch evidence binder into a buyer-facing launch room.

Planned focus:

- Give each buyer stakeholder scoped access with expiry, role, visible proof, and activity receipts
- Show approved binder sections while hiding tenant-local notes, internal holds, and raw customer context
- Route buyer follow-up questions back to proof owners without losing sealed report context
- Record what the buyer saw, who shared it, when access expires, and what changed after follow-up
