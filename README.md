...
**Current version:** v2.5 Alpha

**Current phase:** Beta Onboarding Promise

**Current release:** v2.5 Alpha - Beta Onboarding Promise
...
- Launch Readiness and Beta Operations Meter on the Build page with 100% private-beta launch readiness, 30/30 launch phases done, 0 hidden launch gates, and beta operations at 48% with onboarding-promise gating
...
## Next Phase: v2.6 Alpha - First Review Receipt

- Turn the first beta workflow into a customer-ready proof artifact.
- Capture the first verified answer, score, sources, risk flags, customer feedback, and support effort.
- Show whether the first customer should continue, narrow, hold, or promote the workflow.
- Preserve learning boundaries so customer feedback improves the product without leaking tenant context.
- Keep expansion controlled: no broader invite growth without a first review receipt.
