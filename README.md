...
**Current version:** v1.5 Alpha

**Current phase:** Live Backend Wiring

**Current release:** v1.5 Alpha - Live Backend Wiring
...
- Launch Readiness Meter on the Build page with 90% overall progress, 26/30 done, 1 active backend gate, 3 pending launch gates, and 10% remaining to private beta launch
...
## Next Phase: v1.6 Alpha - Account And Billing Gate

- Confirm first-owner workspace creation, organization setup, defaults, and launch-ready account receipt
- Prove owner, reviewer, contributor, viewer, and buyer-safe link acceptance before private beta opens
- Connect pilot offer, Team plan, upgrade path, invoice owner, and renewal signal without confusing the first screen
- Make support ownership, billing escalation, last-owner safety, and recovery authority visible before accounts go live
- Keep account operations calm enough for multi-country and multi-environment launch expansion
