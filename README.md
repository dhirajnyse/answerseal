...
**Current version:** v2.21 Alpha

**Current phase:** Share Activity Observatory

**Current release:** v2.21 Alpha - Share Activity Observatory
...
## Next Phase: v2.22 Alpha - Shared Brief Follow-Up Console

The next release should turn observed opens, stale proof, and viewer questions into governed follow-up work with owner SLAs, renewal packets, and revoke-or-replace decisions.

Planned focus:

- Collect viewer questions from shared briefs and route each one to the right owner
- Show response clocks, blocked owners, and follow-up promises before buyer confidence drops
- Bundle answered questions, refreshed proof, and activity receipts into a renewed trusted brief
- Convert stale or risky shares into an explicit keep, replace, or revoke decision
