...
**Current version:** v2.23 Alpha

**Current phase:** Renewal Packet Studio

**Current release:** v2.23 Alpha - Renewal Packet Studio
...
## Next Phase: v2.24 Alpha - Renewal Distribution Room

The next release should govern who receives the renewed packet, what old access changes, what resend receipt is created, and how the renewed share is watched.

Planned focus:

- Select the buyer, board, customer, or internal group that should receive the renewed packet
- Decide whether the old packet stays active, is replaced, or is revoked before resend
- Record what changed, who approved it, who received it, and why the renewal is safer
- Attach the post-renewal observation plan before the packet leaves the workspace
