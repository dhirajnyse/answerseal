...
**Current version:** v2.19 Alpha

**Current phase:** Executive Trust Briefing Room

**Current release:** v2.19 Alpha - Executive Trust Briefing Room
...
## Next Phase: v2.20 Alpha - Leadership Share Control Room

The next release should control how leadership briefs are shared: who can see them, what is redacted, when they expire, and how every share is recorded.

Planned focus:

- Define founder, board, sales, customer success, buyer, and advisor views
- Hide tenant-local learning, raw buyer text, private evidence, and customer-sensitive detail by default
- Add expiry and revocation for shared briefs when risk or evidence changes
- Record who received the brief, what version was shared, what was hidden, and what action remains
