...
**Current version:** v2.20 Alpha

**Current phase:** Leadership Share Control Room

**Current release:** v2.20 Alpha - Leadership Share Control Room
...
## Next Phase: v2.21 Alpha - Share Activity Observatory

The next release should watch what happens after a brief is shared: opens, stale proof, viewer questions, revocation triggers, and follow-up owners.

Planned focus:

- Show who opened a shared brief, when it was viewed, and which audience rule applied
- Warn owners when a shared brief depends on aging evidence, changed risk, or replaced proof
- Route leadership or buyer questions back into the proof workflow without exposing private workspace detail
- Recommend revoke, renew, or replace when the shared brief no longer matches the current truth
